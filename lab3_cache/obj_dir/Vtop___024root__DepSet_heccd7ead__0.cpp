...
VlCoroutine Vtop___024root___eval_initial__TOP__0__2(Vtop___024root* vlSelf);
...
VL_INLINE_OPT VlCoroutine Vtop___024root___eval_initial__TOP__0(Vtop___024root* vlSelf) {
    ...
    co_await Vtop___024root___eval_initial__TOP__0__2(vlSelf);
}
...
#endif
                VL_FATAL_MT("utb_CacheAltDpath.v", 17, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("utb_CacheAltDpath.v", 17, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("utb_CacheAltDpath.v", 17, "", "NBA region did not converge.");
            }
